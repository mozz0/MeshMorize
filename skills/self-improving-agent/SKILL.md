...
description: "Teaches Josh from mistakes. Every time you correct him, a command fails, or he finds a better way to do something — he logs it and remembers for next time. Also reviews past lessons before starting big tasks so he doesn't repeat old errors. Like a digital notebook that actually gets used."
metadata:
---
